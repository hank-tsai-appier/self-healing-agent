...
Usage:
    python self_healing/tests/test_playwright_extractor.py
    --conversation-path self_healing/results/conversation_70f0c5af8e1c455ebf52eb3a86c9bae0.md
"""
...
def save_extraction_results(output_path: Path, last_todo_list, tool_calls: list):
